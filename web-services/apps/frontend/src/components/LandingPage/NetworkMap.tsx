    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-light text-zinc-950 dark:text-white leading-tight">
            One compute fabric.{" "}
            <span className="text-zinc-400 dark:text-zinc-600">
              Everywhere.
            </span>
          </h2>
          <p className="text-zinc-600 dark:text-zinc-400 text-sm mt-4 max-w-md mx-auto">
            AWS · GCP · DePIN hosts — unified into a single network.
          </p>
        </motion.div>
        ...
        >
          <div className="absolute inset-0 rounded-full bg-gradient-to-b from-[#9945FF]/10 to-transparent blur-3xl" />
          <Globe />
        </motion.div>
        ...
        >
          {STATS.map((s) => (
            <div key={s.label} className="text-center">
              <div className="text-2xl font-light text-zinc-950 dark:text-white font-mono tabular-nums">
                {s.value}
              </div>
